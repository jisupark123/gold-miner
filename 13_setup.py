...
def setup_gemstone():
    start_gemstones = [
        SmallGold(gemstone_images["small_gold"], (200, 380)),
        SmallGold(gemstone_images["small_gold"], (400, 400)),
        SmallGold(gemstone_images["small_gold"], (600, 450)),
        SmallGold(gemstone_images["small_gold"], (800, 400)),
        SmallGold(gemstone_images["small_gold"], (1150, 380)),
        BigGold(gemstone_images["big_gold"], (300, 500)),
        BigGold(gemstone_images["big_gold"], (800, 500)),
        Stone(gemstone_images["stone"], (300, 380)),
        Stone(gemstone_images["stone"], (700, 330)),
        Stone(gemstone_images["stone"], (1000, 480)),
        Diamond(gemstone_images["diamond"], (900, 420)),
        Diamond(gemstone_images["diamond"], (150, 500)),
    ]

    # 그룹에 추가
    for gemstone in start_gemstones:
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            pygame.quit()
        if event.type == pygame.MOUSEBUTTONDOWN and claw.direction != STOP:
